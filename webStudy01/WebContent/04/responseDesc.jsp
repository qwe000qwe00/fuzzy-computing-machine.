...
<pre>
	...
	1) Response Line : Response Code, Protocol/ver
	...
	** HttpServletResponse 를 통한 응답제어
		...
		3) set[add]Header(header_name, header_value)
		   set[add]IntHeader(header_name, long header_value)
...
// 		  	캐시를 저장하도록 설정
			...
			response.setHeader("Pragme", "public;max-age="+maxAge);
