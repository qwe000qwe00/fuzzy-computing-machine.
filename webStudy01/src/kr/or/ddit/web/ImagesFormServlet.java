...
public class ImagesFormServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      InputStream in = this.getClass().getResourceAsStream("imgForm.html"); // 바이트스트림을 가져옴
      ...
      */
      ...
      int start = html.indexOf("@options"); // 어디서부터 시작인가
      int end = start + "@options".length(); // 길이를 더해줘서 end를 찾는다
